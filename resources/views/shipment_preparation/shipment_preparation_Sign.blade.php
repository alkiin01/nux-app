...
@section('subcontent')
                                            ...
                                            <div class="px-7 py-5">
                                                <div class="mb-10">
                                                    ...
                                                    <select class="form-select form-select-solid fw-bolder"
                                                        ...
                                                        data-allow-clear="false" id="status_id" data-hide-search="true"
                                                        onchange="resetFrontCard()">
                                ...
                                <div class="card">
                                    <div class="card-header card-header-stretch">
                                        <div class="card-title d-flex align-items-center">
                                            ...
                                            <button class="btn btn-light-success btn-sm ms-2 mr-2 mt-2"
                                                onclick="backHome()">Back</button>
                                            <button class="btn btn-success btn-sm ms-2 mr-2 mt-2" id="btn_ready_to_print"
                                                onclick="ready_to_print()">
                                                <span id="btn_text_ready_to_print">Confirm</span>
                                                <span id="spinner_ready_to_print"
                                                    class="spinner-border spinner-border-sm align-middle ms-2"
                                                    style="display: none;"></span>
                                            </button>
                                        </div>
                                            ...
                                            <ul class="nav nav-tabs nav-line-tabs nav-stretch fs-6 border-0 fw-bolder"
                                                ...
                                                <li class="nav-item" role="presentation" onclick="getPreview()">
                                                    <a id="kt_activity_file_tab"
                                                        ...
                                                        data-bs-toggle="tab" role="tab" href="#kt_activity_file">Form
                                                        Input</a>
                                                </li>
                                            </ul>
                                        </div>
                                                    ...
                                                    <div>
                                                        <div class="form-group mb-5">
                                                            ...
                                                            <input type="text" class="form-control bg-light-primary"
                                                                id="PackNum" readonly />
                                                                <input type="hidden" id="CustNum" />
                                                        </div>
                                                        <div class="form-group mb-5">
                                                            <label for="exampleInputPassword1">Legal Number <span
                                                                    class="text-danger">*</span></label>
                                                            <input type="text" class="form-control bg-light-primary"
                                                                id="LegalNumber" readonly />
                                                        </div>
                                                        <div class="form-group mb-5">
                                                            <label>Select SO Number <span
                                                                    class="text-danger">*</span></label>
                                                ...
                                                <form>
                                                    <div>
                                                        ...
                                                        <div class="form-group mb-5">
                                                            ...
                                                            <input type="text" class="form-control" id="int_label"
                                                                placeholder="Scan Barcode" />
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Customer Label<span class="text-danger">*</span></label>
                                                            <input type="text" class="form-control" id="ext_label"
                                                                placeholder="Scan Barcode" />
                                                        </div>
                                                    ...
                                                    <div class="pt-5 pb-5">
                                                        ...
                                                        <button type="button"
                                                            ...
                                                            id="btn_set_order_number" onclick="set_order_number()">
                                                            <span id="btn_text_order_number">Update SO</span>
                                                            <span id="spinner_order_number"
                                                                class="spinner-border spinner-border-sm align-middle ms-2"
                                                                style="display: none;"></span>
                                                        </button>

                                                        <button type="button" class="btn btn-primary btn-sm mr-2 mt-2"
                                                            id="btn_submit_label" onclick="btn_submit_label()">
            ...
            <div class="modal-content shadow-none">
                        ...
                        <div class="card-header border-1 pt-6 pb-6  mb-5">
                            <div class="card-title">
                                <div class="d-flex align-items-center position-relative my-1">
                                    ...
                                    <input type="text" data-kt-goodreceive-table-filter="search"
                                        id="release_table_search"
                                        class="form-control form-control-solid w-250px ps-15 text-sm form-control-sm"
                                        placeholder="Part/Lot" />
                                </div>
                            </div>
                        </div>
                        <div class="card-body pt-0">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal"
                        onclick="refresh_detail_table()">Close</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal bg-white fade" tabindex="-1" id="kt_modal2_show">
        <div class="modal-dialog modal-sm">
            <div class="modal-content shadow-none">
                <div class="modal-header">
                    <h5 class="modal-title">Scan Barcode MMKI</h5>
                    <div class="btn btn-icon btn-sm btn-active-light-primary ms-2" data-bs-dismiss="modal"
                        aria-label="Close">
                        <span class="svg-icon svg-icon-2x"></span>
                    </div>
                ...
                <div class="modal-body text-center">
                    <div class="card mt-10">
                        ...
                        <div class="card-body pt-0">
                            <div class="form-group">
                                <label>Customer Label<span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="ext_label" placeholder="Scan Barcode" />
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function ready_to_print() {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('shipment_preparation.ready_to_print') }}",
                data: string,
                cache: false,
                dataType: 'json',
        ...
        // Scanned by 2nd PIC 
        //function delivery_confirm(packNum, PackLine, SysID, PartNum) {
        //     $("#kt_modal2_show").modal('show');
        ...
        function un_ready_to_print() {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('shipment_preparation.un_ready_to_print') }}",
                data: string,
                cache: false,
                dataType: 'json',
                success: function(data) {
        ...
        function delete_lot(packNum, packLine, sysID) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('shipment_preparation.check_before_delete') }}",
                data: string,
                cache: false,
                dataType: 'json',
                success: function(data) {
        ...
        function getCountDocument() {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('shipment_preparation.get_count_document') }}",
                data: string,
                cache: false,
                dataType: 'json',
                success: function(data) {
        ...
        function front_table() {
            var frontTable = $("#kt_doc_table").DataTable({
                ...
                ajax: {
                    url: "{{ route('shipment_preparation.front_table') }}",
                    type: 'POST',
                    data: function(d) {
                        d._token = $("[name=_token]").val(), d.status_id = $("#status_id").val(), d.section_id =
                            $("#section_id").val(), d.front_table_search = $("#front_table_search").val();
                    },
                    cache: false,
                    dataType: 'json'
                },
        ...
        function delete_document(trc_unix_id) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('shipment_preparation.delete_document') }}",
                data: string,
                cache: false,
                dataType: 'json',
                success: function(data) {
        ...
        function backHome() {
            ...
            $("#temp_id").val('');
            refresh_front_table();
            window.history.pushState('', '', '<?php echo env('BASE_URL'); ?>/shipment_preparation');
        }
        ...
        function detail_release_table() {
            var detailReleaseTable = $("#kt_doc_table_3").DataTable({
                ...
                ajax: {
                    url: "{{ route('shipment_preparation.detail_release_table') }}",
                    type: 'POST',
                    data: function(d) {
                        d._token = $("[name=_token]").val(), d.trc_unix_id = $("#temp_id").val(), d.pack_line =
                            $("#pack_line").val(), d.detail_table_search = $("#release_table_search").val();
                    },
                    cache: false,
                    dataType: 'json'
                },
        ...
        function detail_table() {
            var detailTable = $("#kt_doc_table_2").DataTable({
                ...
                ajax: {
                    url: "{{ route('shipment_preparation.detail_table') }}",
                    type: 'POST',
                    data: function(d) {
                        d._token = $("[name=_token]").val(), d.trc_unix_id = $("#temp_id").val(), d
                            .detail_table_search = $("#detail_table_search").val();
                    },
                    cache: false,
                    dataType: 'json'
                },
        ...
        function getPreview() {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('shipment_preparation.get_preview_doc') }}",
                data: string,
                cache: false,
                dataType: 'json',
                success: function(data) {
                    window.history.pushState('', '', '<?php echo env('BASE_URL'); ?>/shipment_preparation?ref_doc=' +
                        temp_id + '&ref_tab=' + ref_tab);
                    $("#PackNum").val(data.PackNum);
                    $("#CustNum").val(data.CustNum);
        ...
        function add_document() {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('shipment_preparation.add_document') }}",
                data: string,
                cache: false,
                dataType: 'json',
                success: function(data) {
        ...
        function set_order_number() {
            ...
            if (OrderNum != OrderNumSet) {
                ...
                if (confirm(text) == true) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "{{ route('shipment_preparation.set_order_number') }}",
                        data: string,
                        cache: false,
                        dataType: 'json',
                        success: function(data) {
                ...
                success: function(data) {
                    ...
                    setTimeout(function() {
                        ...
                        window.history.pushState('', '',
                            '<?php echo env('BASE_URL'); ?>/shipment_preparation?ref_doc=' + trc_unix_id +
                            '&ref_tab=' + data.ref_tab);
                    }, 500)
                }
            })
        };

        function signApprove(trc_unix_id){
        ...
        function submit_label() {
            ...
            if(CustNum == 3 || CustNum == 6){ //|| CustNum == 9 ){ //SIM
                 Toast.fire({
                                position: 'bottom-end',
            ...
            var string = "&_token=" + token + "&trc_unix_id=" + trc_unix_id + "&OrderNum=" + OrderNum + "&int_label=" +
                int_label + "&ext_label=" + ext_label + "&CustNum=" + CustNum;
            $.ajax({
                type: 'POST',
                url: "{{ route('shipment_preparation.submit_label') }}",
                data: string,
                dataType: 'json',
                cache: false,
                success: function(data) {
                    if (data.process_status == 1) {
                        if (data.ready_to_post == 1) {
                            post_detail(OrderNum, data.order_line, data.order_rel, data.part_num, data
                                .part_name, labelQty, data.po_num, ext_label, data.lot_num);
                        } else {
                            Toast.fire({
                                position: 'bottom-end',
                                title: "Silahkan scan label customer!",
...
let unloadHandler = function (e) {
  ...
  e.returnValue = '';
        ...
        function submit_label_by_slip_no() {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('shipment_preparation.submit_label_by_slip_no') }}",
                data: string,
                dataType: 'json',
                cache: false,
                success: function(data) {
                    if (data.process_status == 1) {
                        ...
                        if(data.code == 405){
                            ...
                            html: `
                                <p>Untuk melanjutkan, silakan ketik kalimat berikut:</p>
                                <strong>"Saya salah scan dan berpotensi salah delivery (WI-35-01)"</strong>
                                <input id="confirmationInput" class="swal2-input" placeholder="Ketik di sini">
                            `,
                            ...
                            didOpen: () => {
                                // Aktifkan proteksi reload saat alert terbuka
                                window.addEventListener('beforeunload', unloadHandler);
                            },
                            willClose: () => {
                                // Nonaktifkan proteksi reload saat alert ditutup
                                window.removeEventListener('beforeunload', unloadHandler);
                            },
                            preConfirm: () => {
                                const input = document.getElementById('confirmationInput').value;
                                if (input !== 'Saya salah scan dan berpotensi salah delivery (WI-35-01)') {
                                Swal.showValidationMessage('Kalimat tidak sesuai. Silakan ketik dengan benar.');
                                spinner.style.display = 'none';
                            buttonText.textContent = 'Submit Label';
                            button.disabled = false;
                                return false;
                            ...
                            button.disabled = false;
                                ...
                                icon: 'success',
                                title: 'Terima kasih!',
                                text: 'Anda telah mengonfirmasi dengan benar.',
                                });
                            }
                            });
                        }else{
        ...
        function post_detail(OrderNum, order_line, order_rel, part_num, part_name, labelQty, po_num, ext_label, lot_num) {
            ...
            var token = $("[name=_token]").val();
            $.ajax({
                url: "{{ route('shipment_preparation.post_detail') }}",
                type: 'POST',
                data: "_token=" + token + "&trc_unix_id=" + trc_unix_id + "&orderNum=" + OrderNum + "&orderLine=" +
                    order_line + "&orderRel=" + order_rel + "&partNum=" + part_num + "&lineDesc=" + part_name +
                    "&displayInvQty=" + labelQty + "&poNum=" + po_num + "&ext_label=" + ext_label + "&lot_num=" +
                    lot_num,
                cache: false,
                success: function(data) {
                    if (data.code == 200) {
