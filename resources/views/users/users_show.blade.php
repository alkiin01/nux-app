                        ...
                        <form id="form_edit_user" onsubmit="handleSubmit(event)" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <select class="form-select" id="gender" name="gender">
                                        ...
                                        <option value="1" {{ $data->gender_id == '1' ? 'selected' : '' }}>Male
                                        </option>
                                        <option value="2" {{ $data->gender_id == '2' ? 'selected' : '' }}>Female
                                        </option>
                                    </select>
                                </div>
                                <div class="col-lg-6">
                            ...
                            <div class="row mt-5">
                                <div class="col-lg-6">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="card border border-2 border-dashed p-3">
                                                <p class="text-muted small fw-bold mb-2">Previous Avatar</p>
                                                @if ($data->avatar && $data->avatar !== 'blank.png')
                                                    <img src="{{ asset('/public/avatar/' . $data->avatar) }}"
                                                        alt="Previous Avatar" class="rounded img-fluid"
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="card border border-2 border-dashed p-3">
                                                <p class="text-muted small fw-bold mb-2">Previous Signature</p>
                                                @if ($data->signature && $data->signature !== 'blank.png')
                                                    <img src="{{ asset('/public/signature/' . $data->signature) }}"
                                                        alt="Previous Signature" class="rounded img-fluid"
                                                        style="height: 150px; object-fit: cover; width: 100%;">
                                                @else
                                                    <div class="d-flex align-items-center justify-content-center rounded"
                                                        style="height: 150px; background-color: #f5f5f5;">
...
<script>
    ...
    function handleSubmit(e) {
        ...
        $.ajax({
            type: 'POST',
            url: '{{ route('data_users.submit_edit') }}',
            data: formData,
            processData: false,
            contentType: false,
            headers: {
