...
<body>
    ...
    <table class="info-table" style="margin-bottom:4px">
        ...
        <tr>
            ...
            <td class="colon">:</td>
            <td class="val">
                {{ $header->CreatedAt ? \Carbon\Carbon::parse($header->CreatedAt)->format('d M Y') : '-' }}
            </td>
        </tr>
    </table>
    ...
    <div class="infos-wrap" style="margin-top: 20px; padding-top: 20px;">
        <table class="infos-table">
            <tr>
                <td style="border-right:none; border-bottom:none; border-left:none; border-top:none">
                </td>
                <td style="border-right:none; border-bottom:none; border-left:none; border-top:none">
                </td>
                <td style="border-right:none; border-bottom:none; border-left:none; border-top:none">
