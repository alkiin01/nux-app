...
class ShipmentPreparationController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('shipment_preparation/shipment_preparation_index', $data); 
    }
    ...
    public function get_attachment_list(Request $request){     
        ...
        return view('shipment_preparation/attachment_list', $data) ;
    }
    ...
    public function get_comment_list(Request $request){     
        ...
        return view('shipment_preparation/comment_list', $data) ;
    }
    ...
    public function export_front_table(Request $request){    
        ...
        $data['ref_form'] = '' ; 
        return view('shipment_preparation.po_export', $data); 
    }
    ...
    public function show(Request $request) {         
        ...
        return view('shipment_preparation.po_preview', $data);  
    }

    function print_view(Request $request){    
        $data['trc_unix_id'] = $request->trc_unix_id ;     
        $data['ref_form'] = $request->ref_form ; 
        return view('shipment_preparation.po_direct_print', $data);
    }  
    ...
    {    
        ...
        // else if ($CustNum == 6){ // SIM
        //     $db_order = ShipmentPreparation::get_order_line_MMKI($OrderNum, $PartNum,$ext_label) ;  
        //     $qrtext = preg_replace('!\s+!', ' ', $ext_label);
        //             $partext = explode(" ",$qrtext);
        //             if(strpos($partext[4], "GE") !== false || strpos($partext[4], "GDM") !== false){
        //                 if (strpos($partext[4], "GE") !== false) {
        //                     $simtag = str_replace("GE", "", $partext[4]);
        //                     $custExp = str_replace(" ","",substr($simtag, 1, 15));
        //                 } else {
        //                     $simtag = str_replace("GDM", "",  $partext[4]);
        //                     $custExp = substr($simtag, 0, 15);
        //                 }
        //             }else if(strpos($partext[3], "PT.SIM")!== false){
        //                 $simtag = str_replace("-","",$partext[5]);
        //             $custExp = substr($partext[5], 0, 15);

        //             }else{
        //             $simtag = str_replace("-","",$partext[3]);
        //             $custExp = substr($partext[3], 0, 15);
        //             }
        //     if ($PartNum != Trim($custExp)){
        //         $error_from = "SHP";
        //         $error_type = "LABEL";
        //         $description = "Label part customer ".$custExp." tidak sesuai dengan label part SAI ". $PartNum ;
                
        //         $error_update = ErrorLogs::logError($error_from, $error_type, $description,0,$OrderNum,$PartNum);
        //         if($CustNum == 6) {
        //             $data['code'] = 405 ;
        //             $data['msg_process'] = Trim($custExp) ;
        //             $data['process_status'] = 0 ;
        //         } 
        //         return json_encode($data);
        //     }
        // }
        //  else if($CustNum == 9){ // TMMIN
        //     $db_order = ShipmentPreparation::get_order_line_MMKI($OrderNum, $PartNum,$ext_label) ;  

        //     $int_label = str_replace("-","",$PartNum);
        //     $qrtext = preg_replace('!\s+!', ' ', $ext_label);
        //     $partext = explode(" ",$qrtext);
        //     $custExp = substr($partext[1], 0, 10);
        //     if ($int_label != Trim($custExp)){
        //         $error_from = "SHP";
        //         $error_type = "LABEL";
        //         $description = "Label part customer ".$custExp." tidak sesuai dengan label part SAI ". $int_label ;
...
if (strlen($ext_label) > 100) {
    $ext_label = substr($ext_label, 0, 99);
}
